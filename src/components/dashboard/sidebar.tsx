...
const staticNavEntries: NavEntry[] = [
  ...
  {
    label: "Equipo & Referidos",
    icon: UserCheck,
    children: [
      { href: "/dashboard/resellers/empleados", label: "Empleados", icon: Briefcase },
      { href: "/dashboard/resellers/influencers", label: "Influencers", icon: Megaphone },
      { href: "/dashboard/resellers/liquidaciones", label: "Liquidaciones", icon: Wallet },
