...
export default function AdminDocumentosPage() {
  // Default a "pending" para la vista de administración
    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Documentos de revendedoras pendientes de aprobación
        </p>
      </div>
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    setModal({
                                      kind: "reject",
                                      id: doc.id,
                                      name: `${resellerName} — ${DOC_TYPE_LABELS[doc.document_type] ?? doc.document_type}`,
                                    })
                                  }
                                >
                                  Rechazar
